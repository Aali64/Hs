...
try:
	prox= requests.get('https://raw.githubusercontent.com/Aali64/data/main/proxies.txt').text
...
android_models=[]
try:
	xx = requests.get('https://raw.githubusercontent.com/Aali64/data/main/strings.txt').text.splitlines()
	for line in xx:
